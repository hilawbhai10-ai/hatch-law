...
export const GetUserDataControler = async (req, res, next) => {
...
export const GetUserPublicDataControler = async (req, res, next) => {
    ...
    try {
        ...
        if (!UserData)
            return res.status(Status_Codes.BAD_REQUEST).json({ Error: "ID Not Found " });
