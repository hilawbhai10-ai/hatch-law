...
router.get("/@me", LoggerMiddleware, SessionCheckingMiddleware, async (req, res, next) => {
    try {
...
router.get("/", LoggerMiddleware, ParamsValidators(UserPublicInfoShema, "Id"), SessionCheckingMiddleware, async (req, res, next) => {
    try {
