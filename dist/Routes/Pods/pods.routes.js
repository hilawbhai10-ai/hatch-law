...
// DISCOVERY
// User pod list
router.get("/@me", SessionCheckingMiddleware, GetPodListController);
// Public pods
router.get("/public", SessionCheckingMiddleware, GetPublicPodsController);
// Search pods
router.get("/search", SessionCheckingMiddleware, loadUserContext, SearchPodsController);
// CREATE PODS
router.post("/create", SessionCheckingMiddleware, loadUserContext, podCreateLimitMiddleware, CreatePodController);
// MEMBERSHIP
// Join pod
router.post("/:podId/join", SessionCheckingMiddleware, loadUserContext, loadPodContext, isPodJoinable, joinPodController);
// Leave pod
router.post("/:podId/leave", SessionCheckingMiddleware, loadUserContext, loadPodContext, requirePodMember, leavePodController);
// POD MANAGEMENT
// Delete pod (OWNER only)
router.delete("/:podId/delete", SessionCheckingMiddleware, loadUserContext, loadPodContext, requirePodRole("owner"), DeletePodController);
// Update pod (OWNER + ADMIN)
router.patch("/:podId/update", SessionCheckingMiddleware, loadUserContext, loadPodContext, requirePodRole("owner", "admin"), UpdatePodController);
// POD INFO
router.get("/:podId", SessionCheckingMiddleware, loadUserContext, loadPodContext, GetPodDetailsController);
// router.get(
//   "/:podId/members",
...
router.post("/:podId/assign-role", SessionCheckingMiddleware, loadUserContext, loadPodContext, requirePodRole("owner"), AssignPodRoleController);
// INVITES
router.post("/:podId/invite-link", SessionCheckingMiddleware, loadUserContext, loadPodContext, requirePodMember, requirePodRole("owner", "admin"), GeneratePodInviteLinkController);
// MESSAGES
// HTTP persistence endpoint
router.post("/:podId/messages", SessionCheckingMiddleware, loadUserContext, loadPodContext, requirePodMember, CreateMessageController);
export default router;
//# sourceMappingURL=pods.routes.js.map