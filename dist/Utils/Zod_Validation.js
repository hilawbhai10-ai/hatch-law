...
export const Signup_zod_schema = z.object({
    ...
    if (DOB_Date.getFullYear() > Minimum_User_Years)
        return false;
    return true;
}, {
    path: ["DOB"],
...
export const SignupOnboardingQuestionsSchema = z.object({
    Questions: z.object({
        Question_1: z.object({
            ...
            Answers: z.enum([...Data_objects.Questions["Question 1"].Answers])
        }),
        Question_2: z.object({
            Question: z.literal(Data_objects.Questions["Question 2"].Question),
            Answers: z.enum([...Data_objects.Questions["Question 2"].Answers])
        }),
        Question_3: z.object({
            Question: z.literal(Data_objects.Questions["Question 3"].Question),
            Answers: z.enum([...Data_objects.Questions["Question 3"].Answers])
        }),
        Question_4: z.object({
            Question: z.literal(Data_objects.Questions["Question 4"].Question),
            Answers: z.enum([...Data_objects.Questions["Question 4"].Answers])
        }),
    })
});
