...
import {
  handleOAuthSignupService,
  simpleSignupService,
  simpleSigninService,
  generateSessionToken
} from "../Services/tempAuth.service.js";



/* ----------------------------- OAUTH SIGNUP ----------------------------- */

export const tempSignupOAuth = async (req: Request, res: Response) => {
...
export const tempSimpleSignup = async (req: Request, res: Response) => {
...
export const tempSignin = async (req: Request, res: Response) => {
  const { email, password } = req.body;
